...
| --- | --- | --- | --- | --- | --- | --- |
| 2020年9月 - 2021年3月 | レンタカー系モバイルアプリケーションのバックエンド開発 | Ruby | Ruby on Rails, MySQL | AWS | WebAPI設計、コーディング | 20名程度 |
...
| 時期 | プロジェクト概要 | 言語 | 使用技術 | 使用IaaS等 | 担当業務 | チーム規模 |
| --- | --- | --- | --- | --- | --- | --- |
| 2021年4月 - 2022年3月 | MLライブラリによる身体動作トラッキング解析結果を提供するWebAPI開発 | Python | PostgreSQL, FastAPI, Numpy, Pandas, OpenCV, 非公開MLライブラリ | AWS | 要件定義、DB設計、ML動体トラッキングのメタプログラミングツールの開発、API設計、コーディング | 3名程度 |
| 2022年4月 - 2023年3月 | レンタカー系Webアプリケーションのフロントエンド開発 | TypeScript | Next.js, TailwindCSS, Storybook | Firebase | UIコンポーネント設計、コーディング | 20名程度 |
| 2022年10月 - 2023年4月 | ブロックチェーンを用いたマーケットプレイスの開発 | TypeScript, Solidity | Firestore, React.js, DynamoDB, GraphQL | AWS Amplify | 要件定義, 顧客折衝(技術要件面), コーディング, スクラム開発運用 | 5名程度 |
| 2023年5月 - 2024年3月 | ポイント系アプリの開発 | Ruby | Ruby on Rails, PostgreSQL | AWS | 要件定義, 顧客折衝(技術要件面), 協力ベンダー折衝, 設計, パフォーマンステストの実施 | 30名程度 |

### GMOビューティー株式会社

[Link](https://beauty.gmo/)
...
| 時期 | プロジェクト概要 | 言語 | 使用技術 | 使用IaaS等 | 担当業務 | チーム規模 |
| --- | --- | --- | --- | --- | --- | --- |
| 2024年4月 - 2025年3月 | 自由診療向けの電子カルテ・予約システム等の開発 | Ruby, TypeScript | Ruby on Rails, MySQL, Angular | GCP | Webアプリケーション全般のコーディング、テスト、要件定義 | 8名程度 |
